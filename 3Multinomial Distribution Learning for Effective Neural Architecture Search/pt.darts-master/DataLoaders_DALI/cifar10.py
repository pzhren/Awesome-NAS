...
class HybridTrainPipeCIFAR(Pipeline):
    def __init__(self, batch_size, num_threads, device_id, data_dir, crop=32, dali_cpu=False, local_rank=0,
                 world_size=1,
                 cutout=0):
        super(HybridTrainPipeCIFAR, self).__init__(batch_size, num_threads, device_id, seed=12 + device_id)
...
class HybridValPipeCIFAR(Pipeline):
    def __init__(self, batch_size, num_threads, device_id, data_dir, crop, size, local_rank=0, world_size=1):
        super(HybridValPipeCIFAR, self).__init__(batch_size, num_threads, device_id, seed=12 + device_id)
...
def get_cifar_iter_dali(type, image_dir, batch_size, num_threads, local_rank=0, world_size=1, val_size=32, cutout=0):
    if type == 'train':
        pip_train = HybridTrainPipeCIFAR(batch_size=batch_size, num_threads=num_threads, device_id=local_rank,
                                          data_dir=image_dir,
        ...
        pip_val = HybridValPipeCIFAR(batch_size=batch_size, num_threads=num_threads, device_id=local_rank,
                                      data_dir=image_dir,
